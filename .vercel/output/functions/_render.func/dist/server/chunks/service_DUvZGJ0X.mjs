...
import { a as isRemoteImage, i as isESMImportedImage, s as isRemoteAllowed, t as inferRemoteSize } from "./remoteProbe_DB_REWEW.mjs";
import { mt as joinPaths, pt as isRemotePath, vt as removeQueryString } from "./render_FJwdtmM0.mjs";
...
var baseService = {
	...
	getURL(options, imageConfig) {
		...
		let url = `${joinPaths("/lms", imageConfig.endpoint.route)}?${searchParams}`;
...
//#endregion
export { resolveDefaultOutputFormat as i, isLocalService as n, parseQuality as r, baseService as t };

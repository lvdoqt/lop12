...
import { c as matchPattern } from "./chunks/remoteProbe_DB_REWEW.mjs";
import { $ as appSymbol, B as setOriginPathname, F as RedirectSinglePageBuiltModule, G as NOOP_MIDDLEWARE_FN, H as isRoute500, I as sequence, J as readBodyWithLimit, L as copyRequest, P as getRouteGenerator, Q as REROUTABLE_STATUS_CODES, R as findRouteToRewrite, T as generateCspDigest, U as MultiLevelEncodingError, V as isRoute404, W as validateAndDecodePathname, X as ASTRO_GENERATOR, Y as ASTRO_ERROR_HEADER, Z as REDIRECT_STATUS_CODES, _t as removeLeadingForwardSlash, a as createConsoleLogger, at as shouldAppendForwardSlash, bt as slash, c as getParams, ct as collapseDuplicateSlashes, d as getFallbackRoute, dt as hasFileExtension, et as clientAddressSymbol, f as routeHasHtmlExtension, ft as isInternalPath, g as getPattern, h as SERVER_ISLAND_COMPONENT, ht as prependForwardSlash, i as PipelineFeatures, it as responseSentSymbol$1, j as renderEndpoint, l as getProps, lt as collapseDuplicateTrailingSlashes, m as routeIsRedirect, mt as joinPaths, n as ALL_PIPELINE_FEATURES, nt as originPathnameSymbol, o as AstroIntegrationLogger, ot as appendForwardSlash, p as routeIsFallback, q as BodySizeLimitError, r as Pipeline, rt as pipelineSymbol, s as routeComparator, st as collapseDuplicateLeadingSlashes, t as Slots, tt as fetchStateSymbol, u as getCustom404Route, ut as fileExtension, w as decodeKey, y as renderPage, yt as removeTrailingForwardSlash, z as getOriginPathname } from "./chunks/render_FJwdtmM0.mjs";
...
var middlewareSecret = "23857696-02e5-4c98-8ad4-5924a3e480f0";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/courses/new.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/admin/courses/[id]/edit.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/admin\\/courses\\/([^/]+?)\\/lessons\\/new\\/?$",
			"segments": [
				[{
					"content": "admin",
					"dynamic": false,
			...
			"params": ["id"],
			"component": "src/pages/admin/courses/[id]/lessons/new.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/admin/courses/[id]/lessons/[lid]/edit",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/admin\\/courses\\/([^/]+?)\\/lessons\\/([^/]+?)\\/edit\\/?$",
			"segments": [
				[{
					"content": "admin",
					"dynamic": false,
			...
			"params": ["id", "lid"],
			"component": "src/pages/admin/courses/[id]/lessons/[lid]/edit.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/admin/courses/[id]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/courses/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/admin/exams/edit/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/exams/new.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/exams/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/lessons/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/admin/questions/edit/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/questions/new.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/questions/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/users/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/attempts.ts",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/blog/by-category",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/blog\\/by-category\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/blog/by-category.ts",
			"pathname": "/api/blog/by-category",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/blog/comment.ts",
			"pathname": "/api/blog/comment",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/courses/enroll.ts",
			"pathname": "/api/courses/enroll",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/courses/progress.ts",
			"pathname": "/api/courses/progress",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/exams-by-subject",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/exams-by-subject\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "exams-by-subject",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/api/exams-by-subject.ts",
			"pathname": "/api/exams-by-subject",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/test-login.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/de-thi.astro",
			"pathname": "/de-thi",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/exams/[id]/result/[attemptId]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/exams\\/([^/]+?)\\/result\\/([^/]+?)\\/?$",
			"segments": [
				[{
					"content": "exams",
					"dynamic": false,
			...
			"params": ["id", "attemptId"],
			"component": "src/pages/exams/[id]/result/[attemptId].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/exams/[id]/take.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/exams/[id]/index.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/forgot-password.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/guide.astro",
			"pathname": "/guide",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"component": "src/pages/khoa-hoc/[slug]/[lessonId].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/khoa-hoc/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/khoa-hoc/index.astro",
			"pathname": "/khoa-hoc",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/ly-thuyet/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/ly-thuyet/index.astro",
			"pathname": "/ly-thuyet",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/sitemap.astro",
			"pathname": "/sitemap",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["subject", "slug"],
			"component": "src/pages/[subject]/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_C0bRGuns.mjs");
var _page1 = () => import("./chunks/about_DAsXoT4H.mjs");
var _page2 = () => import("./chunks/new_DTnIWqmL.mjs");
var _page3 = () => import("./chunks/edit_D2wADpvT.mjs");
var _page4 = () => import("./chunks/new_DgoFoM57.mjs");
var _page5 = () => import("./chunks/edit_CDaywQcv.mjs");
var _page6 = () => import("./chunks/index_DowjJqeI.mjs");
var _page7 = () => import("./chunks/index_ODWn-8gg.mjs");
var _page8 = () => import("./chunks/_id__Blwi3qY7.mjs");
var _page9 = () => import("./chunks/new_C0uRzzeC.mjs");
var _page10 = () => import("./chunks/index_x3K7pRUS.mjs");
var _page11 = () => import("./chunks/index_DLyzXbrr.mjs");
var _page12 = () => import("./chunks/_id__tJTPcRu1.mjs");
var _page13 = () => import("./chunks/new_D15_bLEA.mjs");
var _page14 = () => import("./chunks/index_BSQcwvTz.mjs");
var _page15 = () => import("./chunks/index_CoynPohs.mjs");
var _page16 = () => import("./chunks/index_DSSZxF-C.mjs");
var _page17 = () => import("./chunks/ai_BoWBtiwL.mjs");
var _page18 = () => import("./chunks/attempts_KjP-n0xY.mjs");
var _page19 = () => import("./chunks/callback_DeX6w5-u.mjs");
var _page20 = () => import("./chunks/session_Db09O1BZ.mjs");
var _page21 = () => import("./chunks/by-category_DnTcOvya.mjs");
var _page22 = () => import("./chunks/comment_BiluFVSq.mjs");
var _page23 = () => import("./chunks/enroll__14MqiWZ.mjs");
var _page24 = () => import("./chunks/progress_DKP_ItND.mjs");
var _page25 = () => import("./chunks/exams-by-subject_tvdbh3IA.mjs");
var _page26 = () => import("./chunks/test-login_DOfWl66e.mjs");
var _page27 = () => import("./chunks/contact_CF9IROnw.mjs");
var _page28 = () => import("./chunks/dashboard_DQu2KMLt.mjs");
var _page29 = () => import("./chunks/de-thi_Ck6QFhn-.mjs");
var _page30 = () => import("./chunks/_attemptId__C6CM6251.mjs");
var _page31 = () => import("./chunks/take_Y3iJF5C6.mjs");
var _page32 = () => import("./chunks/index_YralEeUG.mjs");
var _page33 = () => import("./chunks/forgot-password_BrvN9otx.mjs");
var _page34 = () => import("./chunks/guide_DgPSvfB9.mjs");
var _page35 = () => import("./chunks/_lessonId__DBqlYr3h.mjs");
var _page36 = () => import("./chunks/_slug__DyoeMFBQ.mjs");
var _page37 = () => import("./chunks/index_BW6_IcM0.mjs");
var _page38 = () => import("./chunks/login_ABef6KAS.mjs");
var _page39 = () => import("./chunks/_slug__BTOAiQcH.mjs");
var _page40 = () => import("./chunks/index_C591w1QZ2.mjs");
var _page41 = () => import("./chunks/privacy_C2u86qPN.mjs");
var _page42 = () => import("./chunks/profile_BghNCBb7.mjs");
var _page43 = () => import("./chunks/register_DaM-vuOp.mjs");
var _page44 = () => import("./chunks/reset-password_LOZsFgn7.mjs");
var _page45 = () => import("./chunks/rss_CjO5qXYN.mjs");
var _page46 = () => import("./chunks/sitemap_BdzhxLK6.mjs");
var _page47 = () => import("./chunks/sitemap_QNKH_vcC.mjs");
var _page48 = () => import("./chunks/_slug__7vXjrYaC.mjs");
var _page49 = () => import("./chunks/index_CojR236I.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/about.astro", _page1],
	["src/pages/admin/courses/new.astro", _page2],
	["src/pages/admin/courses/[id]/edit.astro", _page3],
	["src/pages/admin/courses/[id]/lessons/new.astro", _page4],
	["src/pages/admin/courses/[id]/lessons/[lid]/edit.astro", _page5],
	["src/pages/admin/courses/[id]/index.astro", _page6],
	["src/pages/admin/courses/index.astro", _page7],
	["src/pages/admin/exams/edit/[id].astro", _page8],
	["src/pages/admin/exams/new.astro", _page9],
	["src/pages/admin/exams/index.astro", _page10],
	["src/pages/admin/lessons/index.astro", _page11],
	["src/pages/admin/questions/edit/[id].astro", _page12],
	["src/pages/admin/questions/new.astro", _page13],
	["src/pages/admin/questions/index.astro", _page14],
	["src/pages/admin/users/index.astro", _page15],
	["src/pages/admin/index.astro", _page16],
	["src/pages/api/ai.ts", _page17],
	["src/pages/api/attempts.ts", _page18],
	["src/pages/api/auth/callback.ts", _page19],
	["src/pages/api/auth/session.ts", _page20],
	["src/pages/api/blog/by-category.ts", _page21],
	["src/pages/api/blog/comment.ts", _page22],
	["src/pages/api/courses/enroll.ts", _page23],
	["src/pages/api/courses/progress.ts", _page24],
	["src/pages/api/exams-by-subject.ts", _page25],
	["src/pages/api/test-login.ts", _page26],
	["src/pages/contact.astro", _page27],
	["src/pages/dashboard.astro", _page28],
	["src/pages/de-thi.astro", _page29],
	["src/pages/exams/[id]/result/[attemptId].astro", _page30],
	["src/pages/exams/[id]/take.astro", _page31],
	["src/pages/exams/[id]/index.astro", _page32],
	["src/pages/forgot-password.astro", _page33],
	["src/pages/guide.astro", _page34],
	["src/pages/khoa-hoc/[slug]/[lessonId].astro", _page35],
	["src/pages/khoa-hoc/[slug].astro", _page36],
	["src/pages/khoa-hoc/index.astro", _page37],
	["src/pages/login.astro", _page38],
	["src/pages/ly-thuyet/[slug].astro", _page39],
	["src/pages/ly-thuyet/index.astro", _page40],
	["src/pages/privacy.astro", _page41],
	["src/pages/profile.astro", _page42],
	["src/pages/register.astro", _page43],
	["src/pages/reset-password.astro", _page44],
	["src/pages/rss.xml.ts", _page45],
	["src/pages/sitemap.astro", _page46],
	["src/pages/sitemap.xml.ts", _page47],
	["src/pages/[subject]/[slug].astro", _page48],
	["src/pages/index.astro", _page49]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///D:/lop12/","cacheDir":"file:///D:/lop12/node_modules/.astro/","outDir":"file:///D:/lop12/dist/","srcDir":"file:///D:/lop12/src/","publicDir":"file:///D:/lop12/public/","buildClientDir":"file:///D:/lop12/dist/client/","buildServerDir":"file:///D:/lop12/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/about","isIndex":false,"type":"page","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/about.astro","pathname":"/about","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/courses/new","isIndex":false,"type":"page","pattern":"^\\/admin\\/courses\\/new\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"new","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/courses/new.astro","pathname":"/admin/courses/new","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/courses/[id]/edit","isIndex":false,"type":"page","pattern":"^\\/admin\\/courses\\/([^/]+?)\\/edit\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/admin/courses/[id]/edit.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/courses/[id]/lessons/new","isIndex":false,"type":"page","pattern":"^\\/admin\\/courses\\/([^/]+?)\\/lessons\\/new\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"lessons","dynamic":false,"spread":false}],[{"content":"new","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/admin/courses/[id]/lessons/new.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/courses/[id]/lessons/[lid]/edit","isIndex":false,"type":"page","pattern":"^\\/admin\\/courses\\/([^/]+?)\\/lessons\\/([^/]+?)\\/edit\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"lessons","dynamic":false,"spread":false}],[{"content":"lid","dynamic":true,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}]],"params":["id","lid"],"component":"src/pages/admin/courses/[id]/lessons/[lid]/edit.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/courses/[id]","isIndex":true,"type":"page","pattern":"^\\/admin\\/courses\\/([^/]+?)\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/admin/courses/[id]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/courses","isIndex":true,"type":"page","pattern":"^\\/admin\\/courses\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/courses/index.astro","pathname":"/admin/courses","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/exams/edit/[id]","isIndex":false,"type":"page","pattern":"^\\/admin\\/exams\\/edit\\/([^/]+?)\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"exams","dynamic":false,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/admin/exams/edit/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/exams/new","isIndex":false,"type":"page","pattern":"^\\/admin\\/exams\\/new\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"exams","dynamic":false,"spread":false}],[{"content":"new","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/exams/new.astro","pathname":"/admin/exams/new","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/exams","isIndex":true,"type":"page","pattern":"^\\/admin\\/exams\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"exams","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/exams/index.astro","pathname":"/admin/exams","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/lessons","isIndex":true,"type":"page","pattern":"^\\/admin\\/lessons\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"lessons","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/lessons/index.astro","pathname":"/admin/lessons","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/questions/edit/[id]","isIndex":false,"type":"page","pattern":"^\\/admin\\/questions\\/edit\\/([^/]+?)\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"questions","dynamic":false,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/admin/questions/edit/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/questions/new","isIndex":false,"type":"page","pattern":"^\\/admin\\/questions\\/new\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"questions","dynamic":false,"spread":false}],[{"content":"new","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/questions/new.astro","pathname":"/admin/questions/new","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/questions","isIndex":true,"type":"page","pattern":"^\\/admin\\/questions\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"questions","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/questions/index.astro","pathname":"/admin/questions","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin/users","isIndex":true,"type":"page","pattern":"^\\/admin\\/users\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"users","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/users/index.astro","pathname":"/admin/users","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/ai","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/ai\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"ai","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/ai.ts","pathname":"/api/ai","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/attempts","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/attempts\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"attempts","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/attempts.ts","pathname":"/api/attempts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/callback","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/callback\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"callback","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/callback.ts","pathname":"/api/auth/callback","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/session","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/session\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"session","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/session.ts","pathname":"/api/auth/session","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/blog/by-category","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/blog\\/by-category\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"blog","dynamic":false,"spread":false}],[{"content":"by-category","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/blog/by-category.ts","pathname":"/api/blog/by-category","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/blog/comment","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/blog\\/comment\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"blog","dynamic":false,"spread":false}],[{"content":"comment","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/blog/comment.ts","pathname":"/api/blog/comment","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/courses/enroll","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/courses\\/enroll\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"enroll","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/courses/enroll.ts","pathname":"/api/courses/enroll","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/courses/progress","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/courses\\/progress\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"courses","dynamic":false,"spread":false}],[{"content":"progress","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/courses/progress.ts","pathname":"/api/courses/progress","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/exams-by-subject","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/exams-by-subject\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"exams-by-subject","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/exams-by-subject.ts","pathname":"/api/exams-by-subject","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/test-login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/test-login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"test-login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/test-login.ts","pathname":"/api/test-login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/dashboard","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard.astro","pathname":"/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/de-thi","isIndex":false,"type":"page","pattern":"^\\/de-thi\\/?$","segments":[[{"content":"de-thi","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/de-thi.astro","pathname":"/de-thi","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/exams/[id]/result/[attemptId]","isIndex":false,"type":"page","pattern":"^\\/exams\\/([^/]+?)\\/result\\/([^/]+?)\\/?$","segments":[[{"content":"exams","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"result","dynamic":false,"spread":false}],[{"content":"attemptId","dynamic":true,"spread":false}]],"params":["id","attemptId"],"component":"src/pages/exams/[id]/result/[attemptId].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/exams/[id]/take","isIndex":false,"type":"page","pattern":"^\\/exams\\/([^/]+?)\\/take\\/?$","segments":[[{"content":"exams","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"take","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/exams/[id]/take.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/exams/[id]","isIndex":true,"type":"page","pattern":"^\\/exams\\/([^/]+?)\\/?$","segments":[[{"content":"exams","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/exams/[id]/index.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/forgot-password","isIndex":false,"type":"page","pattern":"^\\/forgot-password\\/?$","segments":[[{"content":"forgot-password","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/forgot-password.astro","pathname":"/forgot-password","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/guide","isIndex":false,"type":"page","pattern":"^\\/guide\\/?$","segments":[[{"content":"guide","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/guide.astro","pathname":"/guide","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".aspect-w-16[data-astro-cid-iskcshuh]{padding-bottom:56.25%;position:relative}.aspect-w-16[data-astro-cid-iskcshuh] iframe[data-astro-cid-iskcshuh]{width:100%;height:100%;position:absolute;top:0;left:0}\n"},{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/khoa-hoc/[slug]/[lessonId]","isIndex":false,"type":"page","pattern":"^\\/khoa-hoc\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"khoa-hoc","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}],[{"content":"lessonId","dynamic":true,"spread":false}]],"params":["slug","lessonId"],"component":"src/pages/khoa-hoc/[slug]/[lessonId].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/khoa-hoc/[slug]","isIndex":false,"type":"page","pattern":"^\\/khoa-hoc\\/([^/]+?)\\/?$","segments":[[{"content":"khoa-hoc","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/khoa-hoc/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/khoa-hoc","isIndex":true,"type":"page","pattern":"^\\/khoa-hoc\\/?$","segments":[[{"content":"khoa-hoc","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/khoa-hoc/index.astro","pathname":"/khoa-hoc","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".auth-card[data-astro-cid-sjqh5bze]{-webkit-backdrop-filter:blur(20px);background:#ffffffd9;border:1px solid #e2e8f0cc}.dark[data-astro-cid-sjqh5bze] .auth-card[data-astro-cid-sjqh5bze]{background:#0f172ad9;border:1px solid #33415599}.auth-bg[data-astro-cid-sjqh5bze]{background:radial-gradient(at 20%,#6366f114 0%,#0000 60%),radial-gradient(at 80% 20%,#3b82f612 0%,#0000 60%),radial-gradient(at 60% 90%,#8b5cf60d 0%,#0000 60%)}.dark[data-astro-cid-sjqh5bze] .auth-bg[data-astro-cid-sjqh5bze]{background:radial-gradient(at 20%,#6366f11f 0%,#0000 60%),radial-gradient(at 80% 20%,#3b82f61a 0%,#0000 60%),radial-gradient(at 60% 90%,#8b5cf614 0%,#0000 60%)}.input-field[data-astro-cid-sjqh5bze]{background:#f8fafcb3;border:1.5px solid #cbd5e1cc;transition:all .2s}.dark[data-astro-cid-sjqh5bze] .input-field[data-astro-cid-sjqh5bze]{color:#e2e8f0;background:#1e293b99;border-color:#334155cc}.input-field[data-astro-cid-sjqh5bze]:focus{background:#fffffff2;border-color:#6366f1;outline:none;box-shadow:0 0 0 3px #6366f11f}.dark[data-astro-cid-sjqh5bze] .input-field[data-astro-cid-sjqh5bze]:focus{background:#1e293be6;border-color:#818cf8;box-shadow:0 0 0 3px #818cf826}.btn-primary[data-astro-cid-sjqh5bze]{background:linear-gradient(135deg,#6366f1 0%,#4f46e5 50%,#4338ca 100%);transition:all .2s;box-shadow:0 4px 15px #6366f159}.btn-primary[data-astro-cid-sjqh5bze]:hover{background:linear-gradient(135deg,#818cf8 0%,#6366f1 50%,#4f46e5 100%);transform:translateY(-1px);box-shadow:0 6px 20px #6366f173}.btn-primary[data-astro-cid-sjqh5bze]:active{transform:translateY(0)}.btn-primary[data-astro-cid-sjqh5bze]:disabled{opacity:.6;cursor:not-allowed;transform:none}.error-shake[data-astro-cid-sjqh5bze]{animation:.4s ease-in-out shake}@keyframes shake{0%,to{transform:translate(0)}20%{transform:translate(-6px)}40%{transform:translate(6px)}60%{transform:translate(-4px)}80%{transform:translate(4px)}}.fade-in[data-astro-cid-sjqh5bze]{animation:.3s ease-out forwards fadeIn}@keyframes fadeIn{0%{opacity:0;transform:translateY(-6px)}to{opacity:1;transform:translateY(0)}}.logo-icon[data-astro-cid-sjqh5bze]{background:linear-gradient(135deg,#6366f1,#4f46e5);box-shadow:0 4px 12px #6366f166}.pass-toggle[data-astro-cid-sjqh5bze]{color:#94a3b8;transition:color .2s}.pass-toggle[data-astro-cid-sjqh5bze]:hover{color:#6366f1}.dark[data-astro-cid-sjqh5bze] .pass-toggle[data-astro-cid-sjqh5bze]:hover{color:#818cf8}\n"},{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/ly-thuyet/[slug]","isIndex":false,"type":"page","pattern":"^\\/ly-thuyet\\/([^/]+?)\\/?$","segments":[[{"content":"ly-thuyet","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/ly-thuyet/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/ly-thuyet","isIndex":true,"type":"page","pattern":"^\\/ly-thuyet\\/?$","segments":[[{"content":"ly-thuyet","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/ly-thuyet/index.astro","pathname":"/ly-thuyet","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/privacy","isIndex":false,"type":"page","pattern":"^\\/privacy\\/?$","segments":[[{"content":"privacy","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/privacy.astro","pathname":"/privacy","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/profile","isIndex":false,"type":"page","pattern":"^\\/profile\\/?$","segments":[[{"content":"profile","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/profile.astro","pathname":"/profile","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".auth-card[data-astro-cid-fvopxden]{-webkit-backdrop-filter:blur(20px);background:#ffffffd9;border:1px solid #e2e8f0cc}.dark[data-astro-cid-fvopxden] .auth-card[data-astro-cid-fvopxden]{background:#0f172ad9;border:1px solid #33415599}.auth-bg[data-astro-cid-fvopxden]{background:radial-gradient(at 20%,#6366f114 0%,#0000 60%),radial-gradient(at 80% 20%,#3b82f612 0%,#0000 60%),radial-gradient(at 60% 90%,#8b5cf60d 0%,#0000 60%)}.dark[data-astro-cid-fvopxden] .auth-bg[data-astro-cid-fvopxden]{background:radial-gradient(at 20%,#6366f11f 0%,#0000 60%),radial-gradient(at 80% 20%,#3b82f61a 0%,#0000 60%),radial-gradient(at 60% 90%,#8b5cf614 0%,#0000 60%)}.input-field[data-astro-cid-fvopxden]{background:#f8fafcb3;border:1.5px solid #cbd5e1cc;transition:all .2s}.dark[data-astro-cid-fvopxden] .input-field[data-astro-cid-fvopxden]{color:#e2e8f0;background:#1e293b99;border-color:#334155cc}.input-field[data-astro-cid-fvopxden]:focus{background:#fffffff2;border-color:#6366f1;outline:none;box-shadow:0 0 0 3px #6366f11f}.dark[data-astro-cid-fvopxden] .input-field[data-astro-cid-fvopxden]:focus{background:#1e293be6;border-color:#818cf8;box-shadow:0 0 0 3px #818cf826}.input-error[data-astro-cid-fvopxden]{border-color:#f43f5e!important;box-shadow:0 0 0 3px #f43f5e1a!important}.input-success[data-astro-cid-fvopxden]{border-color:#10b981!important}.btn-primary[data-astro-cid-fvopxden]{background:linear-gradient(135deg,#6366f1 0%,#4f46e5 50%,#4338ca 100%);transition:all .2s;box-shadow:0 4px 15px #6366f159}.btn-primary[data-astro-cid-fvopxden]:hover:not(:disabled){background:linear-gradient(135deg,#818cf8 0%,#6366f1 50%,#4f46e5 100%);transform:translateY(-1px);box-shadow:0 6px 20px #6366f173}.btn-primary[data-astro-cid-fvopxden]:active{transform:translateY(0)}.btn-primary[data-astro-cid-fvopxden]:disabled{opacity:.6;cursor:not-allowed;transform:none}.error-shake[data-astro-cid-fvopxden]{animation:.4s ease-in-out shake}@keyframes shake{0%,to{transform:translate(0)}20%{transform:translate(-6px)}40%{transform:translate(6px)}60%{transform:translate(-4px)}80%{transform:translate(4px)}}.fade-in[data-astro-cid-fvopxden]{animation:.3s ease-out forwards fadeIn}@keyframes fadeIn{0%{opacity:0;transform:translateY(-6px)}to{opacity:1;transform:translateY(0)}}.logo-icon[data-astro-cid-fvopxden]{background:linear-gradient(135deg,#6366f1,#4f46e5);box-shadow:0 4px 12px #6366f166}.pass-toggle[data-astro-cid-fvopxden]{color:#94a3b8;transition:color .2s}.pass-toggle[data-astro-cid-fvopxden]:hover{color:#6366f1}.dark[data-astro-cid-fvopxden] .pass-toggle[data-astro-cid-fvopxden]:hover{color:#818cf8}.strength-bar[data-astro-cid-fvopxden]{transition:width .3s,background-color .3s}.field-hint[data-astro-cid-fvopxden]{margin-top:.3rem;font-size:.7rem}\n"},{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/register","isIndex":false,"type":"page","pattern":"^\\/register\\/?$","segments":[[{"content":"register","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/register.astro","pathname":"/register","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/reset-password","isIndex":false,"type":"page","pattern":"^\\/reset-password\\/?$","segments":[[{"content":"reset-password","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/reset-password.astro","pathname":"/reset-password","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/rss.xml","isIndex":false,"type":"endpoint","pattern":"^\\/rss\\.xml$","segments":[[{"content":"rss.xml","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/rss.xml.ts","pathname":"/rss.xml","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/sitemap","isIndex":false,"type":"page","pattern":"^\\/sitemap\\/?$","segments":[[{"content":"sitemap","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/sitemap.astro","pathname":"/sitemap","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/sitemap.xml","isIndex":false,"type":"endpoint","pattern":"^\\/sitemap\\.xml$","segments":[[{"content":"sitemap.xml","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/sitemap.xml.ts","pathname":"/sitemap.xml","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/[subject]/[slug]","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"subject","dynamic":true,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["subject","slug"],"component":"src/pages/[subject]/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.l3iMKMhX.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://lop12.com","base":"/lms","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/lop12/src/pages/[subject]/[slug].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/about.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/courses/[id]/edit.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/courses/[id]/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/courses/[id]/lessons/[lid]/edit.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/courses/[id]/lessons/new.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/courses/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/courses/new.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/exams/edit/[id].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/exams/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/exams/new.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/lessons/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/questions/edit/[id].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/questions/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/questions/new.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/admin/users/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/contact.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/dashboard.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/de-thi.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/exams/[id]/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/exams/[id]/result/[attemptId].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/exams/[id]/take.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/forgot-password.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/guide.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/khoa-hoc/[slug].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/khoa-hoc/[slug]/[lessonId].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/khoa-hoc/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/login.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/ly-thuyet/[slug].astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/ly-thuyet/index.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/privacy.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/profile.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/register.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/reset-password.astro",{"propagation":"none","containsHead":true}],["D:/lop12/src/pages/sitemap.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BP1PZMng.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","D:/lop12/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_Bv1XE2Tt.mjs","\u0000virtual:astro:page:src/pages/exams/[id]/result/[attemptId]@_@astro":"chunks/_attemptId__C6CM6251.mjs","\u0000virtual:astro:page:src/pages/admin/exams/edit/[id]@_@astro":"chunks/_id__Blwi3qY7.mjs","\u0000virtual:astro:page:src/pages/admin/questions/edit/[id]@_@astro":"chunks/_id__tJTPcRu1.mjs","\u0000virtual:astro:page:src/pages/khoa-hoc/[slug]/[lessonId]@_@astro":"chunks/_lessonId__DBqlYr3h.mjs","\u0000virtual:astro:page:src/pages/[subject]/[slug]@_@astro":"chunks/_slug__7vXjrYaC.mjs","\u0000virtual:astro:page:src/pages/ly-thuyet/[slug]@_@astro":"chunks/_slug__BTOAiQcH.mjs","\u0000virtual:astro:page:src/pages/khoa-hoc/[slug]@_@astro":"chunks/_slug__DyoeMFBQ.mjs","\u0000virtual:astro:page:src/pages/about@_@astro":"chunks/about_DAsXoT4H.mjs","\u0000virtual:astro:page:src/pages/api/ai@_@ts":"chunks/ai_BoWBtiwL.mjs","\u0000virtual:astro:page:src/pages/api/attempts@_@ts":"chunks/attempts_KjP-n0xY.mjs","\u0000virtual:astro:page:src/pages/api/blog/by-category@_@ts":"chunks/by-category_DnTcOvya.mjs","\u0000virtual:astro:page:src/pages/api/auth/callback@_@ts":"chunks/callback_DeX6w5-u.mjs","\u0000virtual:astro:page:src/pages/api/blog/comment@_@ts":"chunks/comment_BiluFVSq.mjs","\u0000virtual:astro:page:src/pages/contact@_@astro":"chunks/contact_CF9IROnw.mjs","D:\\lop12\\.astro\\content-assets.mjs":"chunks/content-assets_BNW1matP.mjs","\u0000virtual:astro:page:src/pages/dashboard@_@astro":"chunks/dashboard_DQu2KMLt.mjs","\u0000virtual:astro:page:src/pages/de-thi@_@astro":"chunks/de-thi_Ck6QFhn-.mjs","\u0000virtual:astro:page:src/pages/admin/courses/[id]/lessons/[lid]/edit@_@astro":"chunks/edit_CDaywQcv.mjs","\u0000virtual:astro:page:src/pages/admin/courses/[id]/edit@_@astro":"chunks/edit_D2wADpvT.mjs","\u0000virtual:astro:page:src/pages/api/courses/enroll@_@ts":"chunks/enroll__14MqiWZ.mjs","\u0000virtual:astro:page:src/pages/api/exams-by-subject@_@ts":"chunks/exams-by-subject_tvdbh3IA.mjs","\u0000virtual:astro:page:src/pages/forgot-password@_@astro":"chunks/forgot-password_BrvN9otx.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_C0bRGuns.mjs","\u0000virtual:astro:page:src/pages/guide@_@astro":"chunks/guide_DgPSvfB9.mjs","\u0000virtual:astro:page:src/pages/admin/questions/index@_@astro":"chunks/index_BSQcwvTz.mjs","\u0000virtual:astro:page:src/pages/khoa-hoc/index@_@astro":"chunks/index_BW6_IcM0.mjs","\u0000virtual:astro:page:src/pages/ly-thuyet/index@_@astro":"chunks/index_C591w1QZ2.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_CojR236I.mjs","\u0000virtual:astro:page:src/pages/admin/users/index@_@astro":"chunks/index_CoynPohs.mjs","\u0000virtual:astro:page:src/pages/admin/lessons/index@_@astro":"chunks/index_DLyzXbrr.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_DSSZxF-C.mjs","\u0000virtual:astro:page:src/pages/admin/courses/[id]/index@_@astro":"chunks/index_DowjJqeI.mjs","\u0000virtual:astro:page:src/pages/admin/courses/index@_@astro":"chunks/index_ODWn-8gg.mjs","\u0000virtual:astro:page:src/pages/exams/[id]/index@_@astro":"chunks/index_YralEeUG.mjs","\u0000virtual:astro:page:src/pages/admin/exams/index@_@astro":"chunks/index_x3K7pRUS.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_ABef6KAS.mjs","\u0000virtual:astro:page:src/pages/admin/exams/new@_@astro":"chunks/new_C0uRzzeC.mjs","\u0000virtual:astro:page:src/pages/admin/questions/new@_@astro":"chunks/new_D15_bLEA.mjs","\u0000virtual:astro:page:src/pages/admin/courses/new@_@astro":"chunks/new_DTnIWqmL.mjs","\u0000virtual:astro:page:src/pages/admin/courses/[id]/lessons/new@_@astro":"chunks/new_DgoFoM57.mjs","\u0000virtual:astro:page:src/pages/privacy@_@astro":"chunks/privacy_C2u86qPN.mjs","\u0000virtual:astro:page:src/pages/profile@_@astro":"chunks/profile_BghNCBb7.mjs","\u0000virtual:astro:page:src/pages/api/courses/progress@_@ts":"chunks/progress_DKP_ItND.mjs","\u0000virtual:astro:page:src/pages/register@_@astro":"chunks/register_DaM-vuOp.mjs","\u0000virtual:astro:page:src/pages/reset-password@_@astro":"chunks/reset-password_LOZsFgn7.mjs","\u0000virtual:astro:page:src/pages/rss.xml@_@ts":"chunks/rss_CjO5qXYN.mjs","\u0000virtual:astro:page:src/pages/api/auth/session@_@ts":"chunks/session_Db09O1BZ.mjs","D:/lop12/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_rCN2U1o7.mjs","\u0000virtual:astro:page:src/pages/sitemap@_@astro":"chunks/sitemap_BdzhxLK6.mjs","\u0000virtual:astro:page:src/pages/sitemap.xml@_@ts":"chunks/sitemap_QNKH_vcC.mjs","\u0000virtual:astro:page:src/pages/exams/[id]/take@_@astro":"chunks/take_Y3iJF5C6.mjs","\u0000virtual:astro:page:src/pages/api/test-login@_@ts":"chunks/test-login_DOfWl66e.mjs","D:/lop12/src/components/ExamView":"_astro/ExamView.7JJLQZpk.js","D:/lop12/src/pages/admin/questions/edit/[id].astro?astro&type=script&index=0&lang.ts":"_astro/_id_.astro_astro_type_script_index_0_lang.BzyXePxi.js","D:/lop12/src/pages/[subject]/[slug].astro?astro&type=script&index=0&lang.ts":"_astro/_slug_.astro_astro_type_script_index_0_lang.DqkEfUEZ.js","@astrojs/react/client.js":"_astro/client.DW6xmEpB.js","D:/lop12/src/pages/admin/questions/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.De5tYEYn.js","D:/lop12/src/pages/login.astro?astro&type=script&index=0&lang.ts":"_astro/login.astro_astro_type_script_index_0_lang.BF_15X5K.js","D:/lop12/src/pages/admin/questions/new.astro?astro&type=script&index=0&lang.ts":"_astro/new.astro_astro_type_script_index_0_lang.2iAMITY6.js","D:/lop12/src/pages/admin/exams/new.astro?astro&type=script&index=0&lang.ts":"_astro/new.astro_astro_type_script_index_0_lang.Bc3P_3MT.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/lop12/src/pages/[subject]/[slug].astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`lesson-sidebar-toggle`),t=document.getElementById(`lesson-sidebar`);e&&t&&e.addEventListener(`click`,()=>{t.classList.toggle(`hidden`)});"],["D:/lop12/src/pages/admin/questions/index.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`selectAll`),t=document.querySelectorAll(`.q-checkbox`),n=document.getElementById(`selection-actions`),r=document.getElementById(`selected-count`),i=document.getElementById(`btn-create-exam`);function a(){let i=document.querySelectorAll(`.q-checkbox:checked`).length;r&&(r.textContent=i.toString()),i>0?n?.classList.remove(`hidden`):n?.classList.add(`hidden`),e&&(e.checked=i>0&&i===t.length)}e&&e.addEventListener(`change`,()=>{t.forEach(t=>t.checked=e.checked),a()}),t.forEach(e=>{e.addEventListener(`change`,a)}),i&&i.addEventListener(`click`,()=>{let e=document.querySelectorAll(`.q-checkbox:checked`),t=Array.from(e).map(e=>e.value);t.length>0&&(window.location.href=`/lms/admin/exams/new?q=${t.join(`,`)}`)});"],["D:/lop12/src/pages/admin/exams/new.astro?astro&type=script&index=0&lang.ts","var e=document.querySelectorAll(`.tab-btn`),t=document.getElementById(`manual-section`),n=document.getElementById(`json-section`),r=document.getElementById(`input-mode`);function i(i){i===`manual-section`?(t.classList.remove(`hidden`),n.classList.add(`hidden`),r.value=`manual`,e.forEach(e=>{e.classList.remove(`bg-white`,`dark:bg-slate-700`,`text-blue-700`,`dark:text-white`,`shadow-sm`),e.classList.add(`text-slate-500`,`dark:text-slate-400`)}),document.getElementById(`tab-manual`)?.classList.add(`bg-white`,`dark:bg-slate-700`,`text-blue-700`,`dark:text-white`,`shadow-sm`),document.getElementById(`tab-manual`)?.classList.remove(`text-slate-500`,`dark:text-slate-400`)):(t.classList.add(`hidden`),n.classList.remove(`hidden`),r.value=`json`,e.forEach(e=>{e.classList.remove(`bg-white`,`dark:bg-slate-700`,`text-blue-700`,`dark:text-white`,`shadow-sm`),e.classList.add(`text-slate-500`,`dark:text-slate-400`)}),document.getElementById(`tab-json`)?.classList.add(`bg-white`,`dark:bg-slate-700`,`text-blue-700`,`dark:text-white`,`shadow-sm`),document.getElementById(`tab-json`)?.classList.remove(`text-slate-500`,`dark:text-slate-400`))}e.length&&t&&n&&(e.forEach(e=>{e.addEventListener(`click`,()=>i(e.dataset.target))}),i(`manual-section`));var a=document.getElementById(`subject_id`),o=document.getElementById(`no-subject-warning`),s=document.getElementById(`no-questions-warning`),c=document.getElementById(`questions-list`),l=document.querySelectorAll(`.question-checkbox-item`),u=document.getElementById(`selected-count`);function d(){let e=document.querySelectorAll(`input[name=\"question_ids\"]:checked`).length;u&&(u.textContent=`${e} câu đã chọn`,u.classList.toggle(`hidden`,e===0))}a&&o&&s&&c&&(a.addEventListener(`change`,()=>{let e=a.value;o.classList.add(`hidden`);let t=0;l.forEach(n=>{let r=n.getAttribute(`data-subject-id`),i=n.querySelector(`input[type=\"checkbox\"]`),a=r===e;n.classList.toggle(`hidden`,!a),!a&&i&&(i.checked=!1),a&&t++}),s.classList.toggle(`hidden`,t>0),c.classList.toggle(`hidden`,t===0),d()}),a.value&&a.dispatchEvent(new Event(`change`))),document.querySelectorAll(`input[name=\"question_ids\"]`).forEach(e=>{e.addEventListener(`change`,d)});var f=document.getElementById(`json-data`),p=document.getElementById(`btn-validate-json`),m=document.getElementById(`json-feedback`);p&&f&&m&&p.addEventListener(`click`,()=>{let e=f.value.trim();if(!e){m.textContent=`⚠️ Vui lòng nhập JSON.`,m.className=`text-xs font-semibold text-amber-600 dark:text-amber-400`,m.classList.remove(`hidden`);return}try{let t=JSON.parse(e),n=t.questions||t.questions;if(!Array.isArray(n)||n.length===0)throw Error(`Thiếu mảng \"questions\"`);m.textContent=`✅ JSON hợp lệ (${n.length} câu hỏi)`,m.className=`text-xs font-semibold text-emerald-600 dark:text-emerald-400`,m.classList.remove(`hidden`)}catch(e){m.textContent=`❌ Lỗi: ${e.message}`,m.className=`text-xs font-semibold text-rose-600 dark:text-rose-400`,m.classList.remove(`hidden`)}});var h=document.getElementById(`btn-paste-sample`);h&&f&&h.addEventListener(`click`,async()=>{try{f.value=await(await fetch(`/lms/sample-questions.json`)).text(),f.dispatchEvent(new Event(`input`))}catch{f.value=`{\"title\":\"Mẫu\",\"questions\":[{\"type\":\"mcq\",\"question\":\"Câu hỏi mẫu\",\"option_a\":\"A\",\"option_b\":\"B\",\"option_c\":\"C\",\"option_d\":\"D\",\"correct_option\":\"A\",\"explanation\":\"\",\"difficulty_level\":\"easy\",\"is_dynamic\":false}]}`}});"]],"assets":["/lms/favicon.ico","/lms/robots.txt","/lms/sample-questions.json","/lms/images/hero.png","/lms/images/og-default.png","/lms/_astro/client.DW6xmEpB.js","/lms/_astro/ExamView.7JJLQZpk.js","/lms/_astro/login.astro_astro_type_script_index_0_lang.BF_15X5K.js","/lms/_astro/new.astro_astro_type_script_index_0_lang.2iAMITY6.js","/lms/_astro/react.CD6hyuMb.js","/lms/_astro/_id_.astro_astro_type_script_index_0_lang.BzyXePxi.js","/lms/images/subjects/biology.png","/lms/images/subjects/chemistry.png","/lms/images/subjects/english.png","/lms/images/subjects/geography.png","/lms/images/subjects/history.png","/lms/images/subjects/informatics.png","/lms/images/subjects/ktpl.png","/lms/images/subjects/literature.png","/lms/images/subjects/math.png","/lms/images/subjects/physics.png","/lms/images/subjects/technology.png","/lms/_astro/Layout.l3iMKMhX.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"FcdJ9B/Ne4pb7qaSiZT+FUFPQkq19MAB2/emVH4bJVc=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});

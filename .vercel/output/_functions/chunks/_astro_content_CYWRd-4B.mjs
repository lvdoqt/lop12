...
import { A as unescapeHTML, C as renderTemplate, N as createComponent, T as generateCspDigest, _ as spreadAttributes, gt as removeBase, pt as isRemotePath } from "./render_FJwdtmM0.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_Bv1XE2Tt.mjs");
